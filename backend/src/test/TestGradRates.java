...
public class TestGradRates {
  ...
  public void testSchoolLevelStandardSuccess() throws IOException {
    ...
    HttpURLConnection connection = tryRequest("graduationRates?type=school&&school_name=Orchard%20Collegiate%20Academy");
    ...
    assertTrue(toCheck.get(ServerState.data).toString().contains("96.6"));

    HttpURLConnection connection1 = tryRequest("graduationRates?type=school&&school_name=New%20Explorations%20into%20Science,%20Technology%20and%20Math%20High%20School");
    ...
    assertTrue(toCheck1.get(ServerState.data).toString().contains("93.9"));
  ...
  public void testDistrictLevelStandardSuccess() throws IOException{
    ...
    HttpURLConnection connection = tryRequest("graduationRates?type=district&&number=3");
    Map<String, Object> toCheck = this.deserializationHelper(connection);

    assertEquals(toCheck.get(ErrorState.result), ServerState.success);
    assertTrue(toCheck.get(ServerState.data).toString().contains("77.5 %"));
  }

  @Test
  public void testCitywideStandardSuccess() throws IOException{

    HttpURLConnection connection = tryRequest("graduationRates?type=city");
    Map<String, Object> toCheck = this.deserializationHelper(connection);

    assertEquals(toCheck.get(ErrorState.result), ServerState.success);
    assertEquals(toCheck.get(ServerState.data), CitywideData.citywideGraduationRate);
  }

  @Test
  public void testAbsencesTypeFailure() throws IOException{

    HttpURLConnection connection = tryRequest("graduationRates?type=nonexistent&&school_name=Brooklyn%20Collegiate:%20A%20College%20Board%20School");
    Map<String, Object> toCheck = this.deserializationHelper(connection);
  ...
  public void testSchoolDNEError() throws IOException{
    ...
    HttpURLConnection connection = tryRequest("graduationRates?type=school&&school_name=schoolDNE");
    Map<String, Object> toCheck = this.deserializationHelper(connection);
  ...
  public void testDistrictDNEError() throws IOException{
    ...
    HttpURLConnection connection = tryRequest("graduationRates?type=district&&number=42");
    Map<String, Object> toCheck = this.deserializationHelper(connection);
  ...
  public void testInvalidParameters() throws IOException{
    ...
    HttpURLConnection connection = tryRequest("graduationRates?parameter=DNE&&number=3");
    Map<String, Object> toCheck = this.deserializationHelper(connection);
